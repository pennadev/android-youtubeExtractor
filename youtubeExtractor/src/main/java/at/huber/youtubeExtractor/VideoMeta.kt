...
class VideoMeta(val videoId: String?, val title: String?, val author: String?, val channelId: String?,
                /**
                 * The video length in seconds.
                 */
                val videoLength: Long, val viewCount: Long, val isLiveStream: Boolean) {
