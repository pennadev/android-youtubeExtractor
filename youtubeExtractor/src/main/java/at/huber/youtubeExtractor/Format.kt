...
class Format {
    ...
    var audioBitrate: Int = 0
        private set
    var isDashContainer: Boolean = false
        private set
    var isHlsContent: Boolean = false
        private set
    ...
    internal constructor(itag: Int, ext: String, height: Int, vCodec: VCodec, aCodec: ACodec, audioBitrate: Int,
